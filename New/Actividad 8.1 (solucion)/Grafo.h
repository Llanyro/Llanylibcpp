...
protected:
	...
	// Complejidad espacial: O(n) si el grafo es lineal (un nodo detrás de otro), porque como máximo tenemos n llamadas 
	// recursivas vivas a la vez. Además creamos un array de n componentes (es lo que devolvemos)
...
public:
	...
	// - tamanoRecorrido: la función depositará aquí el numero de nodos que tiene el recorrido
