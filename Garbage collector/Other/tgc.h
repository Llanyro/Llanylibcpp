...
#ifndef LLANYLIB_BASIC_GARBAGE_COLLECTOR_OTHER_TGC_H_
#define LLANYLIB_BASIC_GARBAGE_COLLECTOR_OTHER_TGC_H_
...
#endif /* LLANYLIB_BASIC_GARBAGE_COLLECTOR_OTHER_TGC_H_ */
